<template>
    <svg fill="var(--target-txt)" width="20px" height="20px" viewBox="0 0 32 32" id="icon" xmlns="http://www.w3.org/2000/svg">
        <path
        ...
        <path
            ...
            transform="translate(0 0)" />
        <rect id="_Transparent_Rectangle_" data-name="&lt;Transparent Rectangle&gt;" class="cls-1 fill-none" width="32"
            height="32" />
    </svg>
</template>